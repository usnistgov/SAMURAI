...
PNAGrabberPath = r'U:\67Internal\DivisionProjects\Channel Model Uncertainty\Measurements\Software\SAMURAI_Control\edited_pnagrabber\PNAGrabber\bin\Debug\PNAGrabber.exe'
...
class pnaGrabber:
    def __init__(self,**options):#PNAoutDir='wdir',exePath=PNAGrabberPath):
        ...
        defaults['pnagrabber_exe_path'] = PNAGrabberPath;
    ...
    def run(self,newPath,clean=-1):
        ...
        [newPath,sufNum]= cleanFileName(newPath,clean);
